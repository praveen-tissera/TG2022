...
// information
        ...
        $item1["description"] = 'dummy description';
        $item1["currency"] ="USD";
        $item1["quantity"] =$this->session->userdata()['cart'][0]['quantity'];
        $item1["price"] = $this->session->userdata()['cart'][0]['qty_total_price'];
...
// charges etc.
        $details['tax'] = 0;
        $details['subtotal'] = $this->session->userdata()['cart'][0]['price'];
// ### Amount
