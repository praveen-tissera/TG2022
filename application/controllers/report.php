...
class Report extends CI_Controller
{
	...
	public function receiptPdf(){
		...
		$html = "<table width='100%'><tr><td><h3 style='margin-bottom:0;padding-bottom:0;'>Myrus Yoga And Fitness</h3><p style='margin-top:0;padding-top:0;'>Phone: +94764354222 | Email: info@cta.lk</p></td><td align='right'>Date Issued<br>";
		$html .= date("F j, Y");
		$html .= "</td></tr></table> <hr>";
