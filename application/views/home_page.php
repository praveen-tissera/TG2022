<?php $this->load->view('header'); ?>
    ...
    <div class="container h-100">
      <div class="row h-100 align-items-center">
        <div class="col-lg-12 banner-content-wrapper">
          <h1 class="display-4 text-white mt-5 mb-2 text-center">Myrus Yoga And Fitness</h1>
        ...
        <div class="container">
            <div class="row center-title mb-5">
                ...
                <div class="col-6">
                    ...
                    <p class="text-left">
                    Myrus Yoga And Fitness is a private and a training Institute which is established in year 2018 which implements programs to increase ICT knowledge of our students.
                    </p>
    ...
    width: 176px;" class="card-img img-fluid"  alt="">
                        ...
                        <div class="col-md-8">
                        <div class="card-body">
                            <h2 class="card-title">Yoga Coures</h2>
                            <p class="card-text">
                              </p>
            ...
            <div class="col-6">
                <div class="card mb-3" style="max-width: 540px;">
                    <div class="row no-gutters">
                        ...
                        <div class="col-md-8">
                        <div class="card-body">
                            <h2 class="card-title">Fitness Training Courses</h2>
                            <p class="card-text"></p>
