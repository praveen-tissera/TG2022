...
<div class="container select-user">
    <div class="row">
        <div class="col-6">
            <a href="<?php echo base_url("/index.php/user/guestUser/$productid/$quantity") ?>" class="btn btn-info mx-auto">Guest user</a>
        </div>

        <div class="col-6">
            <a href="<?php echo base_url('index.php/user/login'); ?>" class="btn btn-info">Login</a>
        </div>
    </div>
</div>
