...
<div class="header-mid">
    <div class="container">
        <div class="row">
            <div class="col-md-5">
                <div class="logo">
                    <div class="lname"><a href=""><span><img src="<?= base_url('tool/img/favicon.png')?>">Dilini Bookshop</span></a></div>
                </div>
            </div>
            <div class="col-md-7">
                <div class="row">
...
<div class="footer-area-home">
    <div class="container">
            ...
            <div class="col-md-4">
                <div class="widget">
                    <div class="brand-name">
                        <div class="lname"><a href=""><span>Dilini Bookshop</span></a></div>
        ...
        <div class="copy-right">
            <p><i class="fas fa-copyright"></i>2022 Dilini Bookshop, Inc. <br>All right reserved</p>
        </div>
    </div>
</div>
