...
if(isset($_POST['submit'])){
    $to = "mario.wasilev@gmail.com"; // this is Al-Fathah Engineering RMS email
    ...
    $message2 = "Hello " . $username . ",\n\n" . "This email confirm your successful registration in Al-Fathah Engineering RMS.\n" . "Your registration details are listed below:\n" . "Username:" . $username . "\n\n" . "Password:" . $password . "\n\n\n" . "I hope you enjoy using Al-Fathah Engineering RMS!";
...
?>
	...
	<div class="form-group">
	  ...
	  <div class="col-md-5">
	  <input id="username" name="username" type="text" minlength = "4" placeholder="jbloggs21" class="form-control input-md" required="">
	...
	<div class="form-group">
	  ...
	  <div class="col-md-5">
		<input id="password" name="password" type="password" minlength = "4" placeholder="" class="form-control input-md" required="">
	...
	<div class="form-group">
	  <label class="col-md-4 control-label" for="emailAddress">Type</label>  
	  <div class="col-md-5">
