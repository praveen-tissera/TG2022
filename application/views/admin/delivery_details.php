...
<div class="container" id="print-delivery-details">
	...
	<div class="row">
		<div class="col-lg-8">
			...
			<table class="table borderless">
				...
				<tr>
					<th>Total price</th>
					<td colspan="1"><?= strip_tags($order_detail->total_price) ?>.LKR</td>
				</tr>
				<tr>
					<?php
	...
	<div><h5>* Customer has to pay total <span class="text-info"><?= $order_detail->total_price?>.LKR</span> with shipping cost.</h5></div>
</div>
<br>
<div class="container">
