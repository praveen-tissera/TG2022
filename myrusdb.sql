...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 18, 2023 at 01:18 PM
...
CREATE TABLE `course_table` (
  ...
  `staff_id` int(11) NOT NULL,
  `course_type` enum('certificate','threedays','oneday') NOT NULL,
...
(1, 'Foundation in Flow', 'This qualification reflects the role of personnel working on farms, stations and related rural businesses involved in administering and managing those businesses. Industry expects individuals with this qualification to take personal responsibility and exercise autonomy in undertaking complex work. They must analyze information and exercise judgment to complete a range of advanced skilled activities.', '30000.00', 'active', 2, '', '2020-01-01'),
(2, 'Diploma in Software Engineering', 'The Diploma of Horticulture reflects the role of those who manage amenity horticultural enterprises where a range of skills and knowledge across the breadth of the industry is required or personnel working in horticulture at a level requiring higher technical skills.', '25000.00', 'active', 2, '', '2020-01-02'),
(3, 'Bend & Stretch', 'The Diploma of Horticulture reflects the role of those who manage amenity horticultural enterprises where a range of skills and knowledge across the breadth of the industry is required or personnel working in horticulture at a level requiring higher technical skills.', '25000.00', 'active', 2, 'oneday', '2020-01-02');
...
CREATE TABLE `payment_schedule_table` (
  ...
  `institute_fee` tinyint(1) DEFAULT NULL,
...
INSERT INTO `payment_schedule_table` (`payment_id`, `student_id`, `batch_id`, `payment_status`, `amount`, `institute_fee`, `payment_due_date`, `pay_month`, `added_date`) VALUES
(27, 17, 2, '1st installment', 15000, 0, NULL, '', '2020-11-19'),
(28, 17, 2, '2nd installment', 15000, 0, '2022-02-08', '', '2020-11-19'),
(46, 37, 2, '1st installment', 15000, 0, NULL, '', '2020-11-21'),
(47, 37, 2, '2nd installment', 15000, 0, '2022-02-08', '', '2020-11-21'),
(48, 38, 4, 'full', 25000, 0, NULL, '', '2020-11-24'),
(50, 1, 1, 'full', 30000, 0, NULL, '', '2021-01-13'),
(51, 18, 1, '1st installment', 15000, 0, NULL, '', '2021-01-29'),
(52, 18, 1, '2nd installment', 15000, 0, '2021-01-27', '', '2021-01-29'),
(53, 40, 1, 'full', 30000, 0, NULL, '', '2021-01-29'),
(54, 41, 1, 'full', 30000, 0, NULL, '', '2021-01-31'),
(55, 42, 1, '1st installment', 15000, 0, NULL, '', '2021-01-31'),
(56, 42, 1, '2nd installment', 15000, 0, '2022-02-07', '', '2021-01-31'),
(57, 42, 3, 'full', 25000, 0, NULL, '', '2021-01-31'),
(58, 41, 4, 'full', 25000, 0, NULL, '', '2021-02-16'),
(59, 45, 1, 'full', 30000, 0, NULL, '', '2022-05-01');
...
(47, 'chathura', 'gamage', '2008-02-17', 'chatura@gmail.com', '1111111122', '9eab996c59f50edcdb0213da7c52166ab1e1cf1c', 2, 'active', '2022-06-17');
