...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 27, 2023 at 11:20 AM
...
(8, 'Stationaries', 'All types of stationaries that are manufactured writing materials, including cut paper, envelopes, writing implements, continuous form paper, toy materials for kids and other office supplies', 'stationaries'),
(9, 'Action and Adventures', 'All types of books that includes action as well as adventure journeys.', 'AA'),
(10, 'Classics', 'All types of books that are classic and well-written which have cultural importance.', 'classics'),
(11, 'Comic Books or Graphic Novels', 'All the types of books which are comical as well as graphical books.', 'CBGN'),
(12, 'Detective and Mystery', 'All the book types that are mystery related and all the detective stories.', 'DM'),
(13, 'Fantasy', 'All the books that are imaginative fiction dependent for effect on strangeness of setting such as other worlds or times and of supernatural or unnatural beings.', 'fantasy'),
(14, 'Horror', 'All the books from horror series related and that makes people to get startle, scare, shock, and even repulse.', 'horror'),
(15, 'Short Stories', 'All the books that held brief fictional prose narrative that is shorter than a novel and that usually deals with only a few characters.', 'SS'),
(16, 'Romance', 'All the books that defines romance as a love story.', 'romance'),
(17, 'Cookbooks', 'All the books that used in learning new tricks in the cooking field.', 'cookbooks'),
(18, 'Poetry', 'All the books that includes different poetries of famous poets all around the world.', 'p'),
(19, 'Political Thriller', 'All the books from political thriller which is a type of mystery with a few key differences.', 'pt'),
(20, 'True crime', 'All the types of books that includes all the crime serious about true crimes and made-up.', 'tc'),
(21, 'Biographies', 'All the books from biographies which is a real person\'s life.', 'b'),
(22, 'Fairy Tales', 'All the books from genre of magical story which is usually originating in folklore.', 'ft'),
(23, 'Self Help', 'All the books that are written with the intention to instruct its readers on solving personal problems.', 'sf'),
(24, 'Essays', 'All the books which includes short pieces that might be published in a magazine or newspaper.', 'e'),
(25, 'Novels', 'All the books that includes a piece of long narrative in literary prose.', 'n'),
(26, 'Memoir', 'All the books that are written from the perspective of the author, about an important part of their life narratively.', 'm'),
(27, 'History', 'All the books that describes the history of a country, area or subject.', 'h'),
(28, 'Magaines', 'All the type of literature publications to distribute news and information.', 'm'),
(29, 'Past Papers', 'All the past paper books regarding to any subject from the year 2000.', 'pp'),
(30, 'Photocopies and Printouts', 'All the photocopies and printouts that are requested by the customers.', 'pap');
...
(1, 1, 'Gayan', 'gayan@gmail.com', '01822597379', '123 Colombo 10', 'Dhaka', '1230', '787', 1, '2019-04-12 13:54:12', '32, 27', '1, 1', '1', ''),
(3, 1, 'Sagara', 'sagara@gmail.com', '01683302276', '123 Colombo 7, Cox\'s Bazar', 'Colombo', '4710', '462', 1, '2019-04-12 13:56:22', '25', '1', '0', '0'),
(4, 1, 'Kasuni', 'kasuni@gmail.com', '01822597379', 'None', 'Colombo', '222', '225', 1, '2019-04-12 13:59:07', '17', '1', '1', '1'),
(5, 19, 'MR User', 'user@system.com', '01822597379', '122 Colombo 4', 'Colombo', '1216', '240', 1, '2019-04-12 14:02:54', '31', '1', '1', '0'),
(6, 19, 'MR User', 'user@system.com', '01683302276', '126 Colombo 10', 'Colombo', '1200', '225', 1, '2019-04-12 14:04:30', '17', '1', '0', '0'),
(8, 19, 'Md User', 'user@system.com', '01822597379', '127 Colombo 10', 'Colombo', '1230', '590', 1, '2019-04-21 15:46:10', '43, 42, 41', '1, 1, 1', '1', ''),
(10, 1, 'Methuli', 'methuli@gmail.com', '01683302276', '55 Colombo 10', 'Colombo', '1230', '262', 1, '2019-04-26 07:03:26', '47', '1', '1', '0'),
(11, 23, 'aruni bhagya', 'arunibhagya06022006@gmail.com', '077319224', '236/12, veluwana road , colombo', 'colombo', '00900', '484', 1, '2023-01-29 07:43:50', '47', '2', '0', '0');
...
(1, 'Sagara Kumara', '01822597379', 'sagara@gmail.com', '$2y$12$foG9iqjasAi3aIiFqCe8huWle/4z9/L.CkzdTQ1Dt9Qb2MwiT/qQe', 'Gampaha', 'Sri Lanka', 'U', '2019-02-28 13:51:33'),
(7, 'Admin Dilini', '01683302276', 'admin@gmail.com', '$2y$12$foG9iqjasAi3aIiFqCe8huWle/4z9/L.CkzdTQ1Dt9Qb2MwiT/qQe', 'Colombo', 'Sri Lanka', 'A', '2019-04-21 10:54:26'),
(17, 'Methuli Rajapaksha', '01822597379', 'methuli@gmail.com', '$2y$12$foG9iqjasAi3aIiFqCe8huWle/4z9/L.CkzdTQ1Dt9Qb2MwiT/qQe', 'Colombo', 'Sri Lanka', 'A', '2019-03-12 14:53:55'),
(19, 'User', '01683302276', 'user@system.com', '$2y$12$foG9iqjasAi3aIiFqCe8huWle/4z9/L.CkzdTQ1Dt9Qb2MwiT/qQe', 'Colombo', 'Sri Lanka', 'U', '2019-03-24 13:49:09'),
(20, 'Nishantha', '01683302276', 'nishantha@gmail.com', '$2y$12$foG9iqjasAi3aIiFqCe8huWle/4z9/L.CkzdTQ1Dt9Qb2MwiT/qQe', 'Colombo', 'Sri Lanka', 'U', '2019-03-12 17:07:17'),
(21, 'Kasuni', '01683302276', 'kasuni@gmail.com', '$2y$12$foG9iqjasAi3aIiFqCe8huWle/4z9/L.CkzdTQ1Dt9Qb2MwiT/qQe', 'Colombo', 'Sri Lanka', 'U', '2019-03-14 04:35:02'),
(22, 'Savindu', '01822597379', 'savindu@gmail.com', '$2y$12$foG9iqjasAi3aIiFqCe8huWle/4z9/L.CkzdTQ1Dt9Qb2MwiT/qQe', 'Torront', 'Japan', 'U', '2019-03-27 15:31:34'),
(23, 'Gayan', '01781501769', 'gayan@gmail.com', '$2y$12$foG9iqjasAi3aIiFqCe8huWle/4z9/L.CkzdTQ1Dt9Qb2MwiT/qQe', 'Colombo', 'colombo', 'U', '2019-04-11 10:20:13'),
(24, 'praveen', '0713691344', 'praveen.tissera@gmail.com', '$2y$12$foG9iqjasAi3aIiFqCe8huWle/4z9/L.CkzdTQ1Dt9Qb2MwiT/qQe', '615 A  1/1', 'Pannipitya Road, Thalawathugoda', 'A', '2023-01-29 01:52:19'),
(25, 'aruni bhagya', '0743345796', 'arunibhagya06022006@gmail.com', '$2y$12$o6UimM7e7tocbVQlOfynQuWBdm13Fd8QVEm1cxweGg1/otAYLR1K.', '236/12, veluwana road', 'colombo', 'A', '2023-01-29 07:51:19'),
(26, 'Kasun Kumara', '0128564778', 'kasunkumara2@yahoo.com', '$2y$12$5E8gpNuORQgifxNZDMlpUu7Y95BqWfKPpLbSgOZqJCSUaNwwL61ia', 'Galle road, Colombo', 'colombo', 'U', '2023-02-12 07:12:23'),
(27, 'Shylee', '0458335903', 'shylee.pe23@gmail.com', '$2y$12$b418BIU3K7HlJ4iJoZdoq.pMI3J.rd0oqBS/8mXtV1hTVLfyTTycy', 'new mania', 'greenland', 'U', '2023-02-12 07:15:17'),
(28, 'roshini med', '0126776797', 'rosh.med@gmail.com', '$2y$12$/TqAkWpkRqx1OwVtevQWT.EgVmQz8rFqyyZUCOF91ftt73W.Bc7N2', 'nuwaraeliya road', 'nuwaraeliya', 'U', '2023-02-20 07:06:33');
...
--
ALTER TABLE `ebooks`
  ADD CONSTRAINT `ebooks_ibfk_1` FOREIGN KEY (`categoryId`) REFERENCES `category` (`id`);
...
--
ALTER TABLE `order_items`
  ADD CONSTRAINT `order_items_ibfk_1` FOREIGN KEY (`bookId`) REFERENCES `books` (`id`),
